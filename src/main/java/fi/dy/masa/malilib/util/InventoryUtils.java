...
public class InventoryUtils
{
    ...
    {
        return ((stack1.isDamageable() && !stack1.isEmpty() && !stack2.isEmpty() && ItemStack.areItemsEqual(stack1, stack2)) ||
                (ItemStack.areItemsEqual(stack1, stack2) && ItemStack.canCombine(stack1, stack2)));
    }
